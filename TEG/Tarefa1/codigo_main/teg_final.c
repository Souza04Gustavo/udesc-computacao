...
#define K 2 // num de clusters

int matAd[NUM_VERTICES][NUM_VERTICES];
int clusters[NUM_VERTICES]; // Cluster de cada vertice
int centroids[K];           // indices dos centroides
...
int main()
{
    ...
    */
    ...
    int centro1 = chute_centro1, centro2 = chute_centro2;
    ...
    for (int i = 0; i < NUM_VERTICES; i++)
    {
        ...
        FILE *grafo_setosa_media = fopen("grafo_setosa_media.txt", "w");
    ...
    for (int i = 0; i < row; i++)
    {
        for (int j = (i + 1); j < row; j++)
        {
            if (matAd[i][j] == 1)
            {
                ...
                {
                    fprintf(grafo_setosa_media, "%i, %i\n", i, j);
                }
            }
        }
    }
    ...
    FILE *grafo_NaoSetosa_media = fopen("grafo_NaoSetosa_media.txt", "w");
    ...
    for (int i = 0; i < row; i++)
    {
        for (int j = (i + 1); j < row; j++)
        {
            if (matAd[i][j] == 1)
            {
                if (num2[i] == 1 && num2[j] == 1)
                {
                    fprintf(grafo_NaoSetosa_media, "%i, %i\n", i, j);
                }
            }
        }
    }
    ...
    FILE *grafo_setosa_k_means = fopen("grafo_setosa_k_means.txt", "w");
    ...
    for (int i = 0; i < row; i++)
    {
        for (int j = (i + 1); j < row; j++)
        {
            if (matAd[i][j] == 1)
            {
                if (clusters[i] == 0 && clusters[j] == 0)
                {
                    fprintf(grafo_setosa_k_means, "%i, %i\n", i, j);
                }
            }
        }
    }
    ...
    FILE *grafo_Nsetosa_k_means = fopen("grafo_Nsetosa_k_means.txt", "w");
    ...
    for (int i = 0; i < row; i++)
    {
        for (int j = (i + 1); j < row; j++)
        {
            if (matAd[i][j] == 1)
            {
                ...
                {
                    fprintf(grafo_Nsetosa_k_means, "%i, %i\n", i, j);
                }
            }
        }
    }
